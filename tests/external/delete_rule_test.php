 ...
 */
final class delete_rule_test extends \advanced_testcase {
    /**
     * @var rule
     */
    private static $rule;
    ...
    /**
     *  Testing execute delete rule test
     *
     * @covers       \local_notificationsagent\external\delete_rule::execute
     * @covers       \local_notificationsagent\external\delete_rule::execute_returns
     * @covers       \local_notificationsagent\external\delete_rule::execute_parameters
