...
use local_notificationsagent\external\update_rule_share;

/**
 * Testing external update rule share
 *
...
class update_rule_share_test extends \advanced_testcase {
    ...
    /**
     *     * Testing execute udpate rule share
     *
     * @covers       \local_notificationsagent\external\update_rule_share::execute
     * @covers       \local_notificationsagent\external\update_rule_share::execute_returns
     * @covers       \local_notificationsagent\external\update_rule_share::execute_parameters
    ...
    public static function dataprovider(): array {
        return [
                'No instance' => [1, 0, 'nosuchinstance', rule::SHARED_RULE],
                'Permissions shared' => [2, 1, '', rule::SHARED_RULE],
                'Permissions no shared' => [2, 1, '', rule::UNSHARED_RULE],
                'No Permissions' => [0, 1, 'nopermissions', rule::SHARED_RULE],
        ];
    }
}
