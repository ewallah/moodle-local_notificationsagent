...
/**
 * Class for testing activitysinceend observer
 *
...
final class activitysinceend_observer_test extends \advanced_testcase {
     ...
     *
     * @return void
     * @covers       \notificationscondition_activitysinceend_observer::course_module_completion_updated
    ...
    public function test_course_module_completion_updated($time, $data): void {
        ...
        $objdb->parameters = '{"time":"' . $data . '", "cmid":"' . $modinstance->cmid . '"}';
